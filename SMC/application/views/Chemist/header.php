            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs"> Mihir</span>
                </a>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="<?= base_url();?>chemist"><i class="fa fa-home"></i><span>Dashboard</span></a></li>
            <li><a href="<?= base_url();?>chemist/kat"><i class="fa fa-home"></i><span>Add Category</span></a></li>
            <li><a href="<?= base_url();?>chemist/medicines"><i class="fa fa-home"></i><span>Add Medicine</span></a></li>
            <li><a href="<?= base_url();?>chemist/med_view"><i class="fa fa-home"></i><span>Medicine Information</span></a></li>
