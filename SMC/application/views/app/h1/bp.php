 ...
 <section class="content">
        ...
        <div class="col-md-12">
              ...
              ?>
                  ...
                  $query = $this->db->get_where('bp', array('r_number' => $username), $limit);
                  ...
                  <div class="box-body">   
                    ...
                    <table class="table">
                            ...
                            <thead>
                             ...
                             <?php 
                              $query = $this->db->get_where('bp', array('r_number' => $username));
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       <section class="content">
        <div class="row">
        <div class="col-md-12">
        <form action="<?php  echo base_url();?>app/in_bp" method="post">
              <!-- general form elements -->
              <div class="box box-primary">
                <!-- /.box-header -->
              ...
              ?>
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="bp" name="bp" placeholder="Enter Updated Value" required>
                    </div>
