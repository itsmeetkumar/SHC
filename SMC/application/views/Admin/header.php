            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs"> Harsh</span>
                </a>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="<?= base_url();?>admin/home"><i class="fa fa-home"></i><span>Add Doctor</span></a></li>          
            <li><a href="<?= base_url();?>admin/chemist"><i class="fa fa-home"></i><span>Add Chemist</span></a></li>
            <li><a href="<?= base_url();?>admin/lab"><i class="fa fa-home"></i><span>Add Laboratory</span></a></li>
            <li><a href="<?= base_url();?>admin/admin_pat"><i class="fa fa-home"></i><span>Admit Patient</span></a></li>
