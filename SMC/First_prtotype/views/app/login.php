...
<html>
  <head>
   ...
   <link rel="stylesheet" href="<?php echo base_url(); ?>meet/AdminLTE/dist/font-awesome/css/font-awesome.min.css">
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>meet/AdminLTE/plugins/iCheck/square/blue.css">
  ...
  <body class="hold-transition login-page">
    ...
    <!-- Bootstrap 3.3.5 -->
    <script src="<?php echo base_url(); ?>meet/AdminLTE/bootstrap/js/bootstrap.min.js"></script>
    <!-- iCheck -->
    <script src="<?php echo base_url(); ?>meet/AdminLTE/plugins/iCheck/icheck.min.js"></script>
    <script>
      $(function () {
        $('input').iCheck({
