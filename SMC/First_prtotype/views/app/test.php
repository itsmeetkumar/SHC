...
?>
          ...
          <div class="box box-widget widget-user-2">
                ...
                <div class="widget-user-header bg-green">
                    ...
                    <img class="codemeet"  src="https://cdn1.iconfinder.com/data/icons/convention-and-exhibition-center/100/Agenda-512.png" alt="User Avatar">
                  
                  <!-- /.widget-user-image -->
                  <h4 class="widget-user-username">LOGIN</h4>
